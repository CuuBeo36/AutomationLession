...
import com.anhtester.Utils.BaseTest;
...
public class DemoJavascriptExecutor extends BaseTest {
    @Test (description = "Test demo JavascriptExecutor")
    ...
    @Test (description = "Test demo sendKey")
    ...
    @Test (description = "Test demo Scroll to element")
    ...
    @Test (description = "Test demo highlight element")
